...
const Scholarship = () => {
    return (
        <div >
            <hr />
            <div className='main'>
                <img className='ml-20' src="https://printabletemplates.com/wp-content/uploads/2020/07/scholarship-certificate-19.jpg" alt="" />

                <div>
                    <div className='text'>
                        <h1 className='title-2 mt-10 ml-20'>কোর্সে ভালো করলে এককালীন <span>১০০০০০</span> টাকা শিক্ষাবৃওির সুযোগ !!!
                            <i class="fa-solid fa-sack-dollar dollar"></i>
                            <i class="fa-solid fa-sack-dollar dollar"></i>
                            <i class="fa-solid fa-sack-dollar dollar"></i>
                        </h1>
                        <p className='normal-text mt-5 mr-20 ml-20'>
                        ...
                        <h1 className='success mt-4'>বিগত বছরের সফল ছাএ।</h1>
                    </div>
                </div>
            </div>
        </div >
