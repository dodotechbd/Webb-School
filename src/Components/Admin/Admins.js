  ...
  return (
    ...
    <div class="card w-full bg-base-300 hover:shadow-primary hover:shadow-lg">
      ...
      <div class="card-body items-center text-center">
        <h2 class="card-title">Rashel Mahomud</h2>
    ...
    <div class="card w-full bg-base-300 hover:shadow-primary hover:shadow-lg">
      ...
      <div class="card-body items-center text-center">
        <h2 class="card-title">Tasmia Ishika</h2>
        <p>Chattogram, Bangladesh</p>
      </div>
    </div>
      <div class="card w-full bg-base-300 hover:shadow-primary hover:shadow-lg">
        ...
        <div class="card-body items-center text-center">
          <h2 class="card-title">Amit Sharma</h2>
          <p>Chattogram, Bangladesh</p>
        </div>
      </div>
      <div class="card w-full bg-base-300 hover:shadow-primary hover:shadow-lg">
        ...
        <div class="card-body items-center text-center">
          <h2 class="card-title">Shakhawath Hossain</h2>
      ...
      <div class="card w-full bg-base-300 hover:shadow-primary hover:shadow-lg">
        ...
        <div class="card-body items-center text-center">
          <h2 class="card-title">Md Badsha</h2>
          <p>Dhaka, Bangladesh</p>
        </div>
      </div>
      <div class="card w-full bg-base-300 hover:shadow-primary hover:shadow-lg">
        ...
        <div class="card-body items-center text-center">
          <h2 class="card-title">Muhammad Shafi</h2>
          <p>Chattogram, Bangladesh</p>
        </div>
      </div>
    </div>
