      ...
      <div className="hero-content flex-col">
        <div className="card flex-shrink-0">
          <div className="card-body lg:w-96 p-5">
            <h1 className="text-xl font-mono uppercase border-b border-gray-500 pb-1 mb-2"><i className="fa-solid fa-circle-info"></i> Account Info</h1>
            <div className="flex gap-6 justify-items-start"><h1><i className="fa-solid fa-id-card-clip"></i> Name:</h1><h1 className="text-setart">{user?.displayName}</h1></div>
            <div className="flex gap-6 justify-items-start"><h1><i className="fa-solid fa-envelope"></i> Email:</h1><h1 className="text-setart">{user?.email}</h1></div>
            <div className="flex gap-6 justify-items-start"><h1><i className="fa-solid fa-bookmark"></i> Role:</h1><h1 className="text-setart">{role === 'admin' ? 'Admin' : 'User'}</h1></div>
            <div className="flex gap-6 justify-items-start"><h1><i className="fa-solid fa-square-phone"></i> Phone:</h1><h1 className="text-setart">{user?.Phone ? user?.phone : '----'}</h1></div>
          </div>
        </div>
        <h1 className="text-lg border-b border-gray-500 font-mono mt-4 uppercase">
          Fully secured payment guarante <i className="fa-solid text-primary fa-credit-card"></i></h1>
