...
const AudioPlayer = () => {
    ...
    return (
        <div className={styles.audioPlayer}>
            ...
            <button className={styles.forwardBackward} onClick={backThirty}><span className='ml-4'>⬅️30</span> </button>
            <span className='ml-4'><button onClick={togglePlayPause} className={styles.playPause}>
