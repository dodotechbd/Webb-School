...
const AdmissionCard = ({ admission }) => {
  ...
  return (
    <div className=" rounded-lg">
      <a href={link} target="blank" className="group mx-4 rounded h-20 lg:h-fit min-w-fit card card-side bg-slate-200 transform transition duration-500 hover:scale-110 hover:shadow-xl">
        <figure>
