  ...
  return (
    <div>
      <div className="zero hero -mt-12 pt-12 min-h-screen bg-base-100 border-b border-neutral">
        ...
        <img className="lg:w-7/12" src='https://raw.githubusercontent.com/MShafiMS/admission/eeb6c9456e6bec86eeddaf072a43cd089f371637/hero.svg' />
          <div className="w-11/12">
            <h1 className="text-7xl text-warning font-mono drop-shadow-lg text-center lg:text-left">Webb</h1>
            <h1 className="text-7xl text-info font-mono drop-shadow-lg text-center lg:text-left">School</h1>
            ...
            <div className="flex lg:mx-0 mx-auto items-center w-80 justify-between bg-gray-600 bg-opacity-40 backdrop-filter backdrop-blur-lg p-2 rounded-2xl">
              ...
              <Link to={'signup'} className="btn btn-accent font-thin rounded-2xl btn-sm text-white shadow-lg">Enroll Now</Link>
              </div>
            </div>
          </div>
        </div>
