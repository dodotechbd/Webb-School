...
const ReviewCard = ({ course }) => {
  ...
  return (
    <div>
      <div className="card w-11/12 lg:w-96 md:w-96 mx-auto bg-base-200 border border-neutral">
        <div className="card-body p-7">
          ...
          <p className="card-body rounded-lg border border-neutral border-l-primary border-l-4 p-4 bg-base-300 text-left">
            {description}
          </p>
