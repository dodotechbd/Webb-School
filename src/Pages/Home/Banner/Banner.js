    ...
    <div className="banner">
      <div className="px-12 lg:pb-16 py-10 pt-2  bg-base-100 border-b border-neutral hero-overlay bg-opacity-50">
        <div className="container mx-auto">
          <h1 className="lg:text-4xl md:text-3xl text-2xl lg:mt-10 lg:mb-12 my-6 font-header font-bold text-center">
          ...
          >
            <SwiperSlide className="card mb-8 shadow-xl">
              <Link to={"/course/english-for-career-development"}>
                <img
                  src="https://i.postimg.cc/J0XQf9dR/18899221.png"
                  alt="image"
                />
              </Link>
            </SwiperSlide>
            <SwiperSlide className="card mb-8 shadow-xl">
              <Link to={"/course/medical-admission-course"}>
                <img
                  src="https://i.postimg.cc/MTd507f8/18899230.png"
                  alt="image"
                />
              </Link>
            </SwiperSlide>
            <SwiperSlide className="card mb-8 shadow-xl">
              <Link to={"/course/varsity-admission-course"}>
                <img
                  src="https://i.postimg.cc/T1vbDhCX/18899243.png"
                  alt="image"
                />
              </Link>
            </SwiperSlide>
            <SwiperSlide className="card mb-8 shadow-xl">
              <Link to={"/course/bank-job"}>
                <img
                  src="https://i.postimg.cc/252Pjhct/18899245.png"
                  alt="image"
                />
              </Link>
            </SwiperSlide>
            ...
            <SwiperSlide className="card mb-8 shadow-xl">
              <Link to={"/course/improve-english-communcation-skills"}>
                <img
                  src="https://i.postimg.cc/QNg9z8fH/Black-Friday-Instagram-Story-05.png"
                  alt="image"
                />
              </Link>
            </SwiperSlide>
            <SwiperSlide className="card mb-8 shadow-xl">
              <Link to={"/course/chinese-for-beginners"}>
                <img
                  src="https://i.postimg.cc/fy2QtSfH/Black-Friday-Instagram-Story-10.png"
                  alt="image"
                />
              </Link>
            </SwiperSlide>
            <SwiperSlide className="card mb-8 shadow-xl">
              <Link to={"/course/developer-job"}>
                <img
                  src="https://i.postimg.cc/fRshrsgT/Black-Friday-Instagram-Story-14.png"
                  alt="image"
                />
              </Link>
            </SwiperSlide>
            <SwiperSlide className="card mb-8 shadow-xl">
              <Link to={"course/grammar-and-punctuation"}>
                <img
                  src="https://i.postimg.cc/dVPfV98W/Black-Friday-Instagram-Story-18.png"
                  alt="image"
                />
              </Link>
            </SwiperSlide>
