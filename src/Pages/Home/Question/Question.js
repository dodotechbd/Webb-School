    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="text-center mb-20">
        ...
        <p className="lg:text-2xl md:text-xl text-lg mt-6 mb-12 text-center font-sub">
          The most common questions about how our Courses works and what can do
          for you.
        </p>
      </div>
      <div className="flex flex-wrap font-sub lg:w-auto sm:mx-auto sm:mb-2 -mx-2">
        <div className="w-full lg:w-1/2 px-4 py-2">
          ...
          <details className="mb-4">
            ...
            <p className="p-5 text-lg shadow-lg bg-base-300 rounded-b-lg">
              These course are for those who want to do something in future and
        ...
        <div className="w-full lg:w-1/2 px-4 py-2">
          <details className="mb-4">
            ...
            <p className="p-5 text-lg shadow-lg bg-base-300 rounded-b-lg">
              Our instructors: Tasmia, Rashel, Badsha, Shakhawath, Shafi,
              Amortha.
            </p>
          </details>
          <details className="mb-4">
          ...
          <details className="mb-4">
            ...
            <p className="p-5 text-lg shadow-lg bg-base-300 rounded-b-lg">
              You can communicate our Email address and our Phone numbers , you
              can massage our website Chat system.
            </p>
          </details>
        </div>
      </div>
